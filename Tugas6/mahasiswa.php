...
<head>
    ...
    <link rel="stylesheet" href="prakpemweb6.css">
    <title>Data Mahasiswa KKN Kelompok 122</title>
</head>
<body>
    <h2>Data Mahasiswa KKN Kelompok 122</h2>
        ...
        <form action="caridata.php" method="get">
            ...
            <select name="prodi" id="prodi">
                ...
                <?php
                    ...
                    $query_prodi = "SELECT DISTINCT prodi FROM kkn";
    ...
    <section class="card">
        <h2>Tambah Data Mahasiswa Kelompok 122</h2>
    ...
    <section class="card">
        <h2>Hapus Data Berdasarkan NIM Mahasiswa Kelompok 122</h2>
